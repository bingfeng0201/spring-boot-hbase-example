...
public class TestHbase {
    ...
    static {
        ...
        conf.set("hbase.zookeeper.quorum","101.200.143.74");
        conf.set("hbase.zookeeper.property.clientPort","2181");
        conf.set("log4j.logger.org.apache.hadoop.hbase","DEBUG");
    }
    ...
    public static void main(String[] args) throws Exception {
        System.setProperty("hadoop.home.dir", "C:\\Users\\hyy\\Desktop\\hadoop");
       TestHbase.createTable("test_tb","model","mac","chip","emmcId","barcode","tcVersion","systemVersion");
